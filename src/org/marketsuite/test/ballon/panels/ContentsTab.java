...
import org.marketsuite.test.ballon.CompleteExample;
...
public class ContentsTab extends JPanel {
	...
	public ContentsTab() {
		...
		contents1.setIcon(new ImageIcon(CompleteExample.class.getResource("/org/marketsuite/test/ballon/resource/frameIcon.png")));
		...
		comp2.setIcon(new ImageIcon(CompleteExample.class.getResource("/org/marketsuite/test/ballon/resource/frameIcon.png")));
		panel2.add(comp2);
