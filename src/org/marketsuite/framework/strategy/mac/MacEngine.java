...
*/
public class MacEngine extends AbstractEngine {
    //-----CTOR-----
    public MacEngine(FundData fund) { _Fund = fund; }
...
//        logTransactions();//for logging
    ...
    public String getId() { return "Three EMA Crossing"; }
...
//        System.out.println(buf);
    ...
    //----- literals -----
    public static int _nEntryMA1 = 50;
